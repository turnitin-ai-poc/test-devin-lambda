...
import com.turnitin.__TEMP__project_name_lower_caseTEMP__.core.dao.SimpleRecord;
...
@Slf4j
public class __TEMP__project_name_pascal_caseTEMP__DynamoPost extends ApiGatewayLambda<SimpleRecord> {
    static final String DYNAMO_TABLE = "dynamo_table";

    private final Dao dao;

    // This constructor is for regular flow
    public __TEMP__project_name_pascal_caseTEMP__DynamoPost() {
    ...
    public __TEMP__project_name_pascal_caseTEMP__DynamoPost(TurnitinContext ctx, Dao mockedDao) {
        this.ctx = ctx;
        this.dao = mockedDao;
    }
